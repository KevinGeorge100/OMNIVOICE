...
export default function FeatureGrid() {
  const features = [
    {
      icon: Zap,
      title: "Sub-500ms Pipeline Target",
      tag: "REAL-TIME LATENCY",
      desc: "Neural VAD detects caller speech in under 20ms and halts carrier playback in less than 50ms. Designed for natural turn-taking without awkward delays.",
      stat: "<500ms",
      statLabel: "Pipeline Target",
    },
    {
      icon: Globe2,
      title: "11 Indian Language Codes",
      tag: "SARVAM AI MODELS",
      desc: "Integrated with Sarvam AI speech models supporting Hindi, Tamil, Telugu, Marathi, Bengali, Kannada, Malayalam, Odia, Gujarati, Punjabi, and English.",
      stat: "11",
      statLabel: "Language Codes",
    },
    {
      icon: Database,
      title: "Local FAQ Fast-Path Cache (<2ms)",
      tag: "COMPUTE OPTIMIZATION",
      desc: "Approved FAQs bypass LLM inference entirely, returning answers in under 2ms measured in-process. Cuts token usage and cloud inference costs by up to 65%.",
      stat: "<2ms",
      statLabel: "In-Process Benchmark",
    },
    {
      icon: ShieldAlert,
    ...
    },
    {
      ...
      stat: "2",
      statLabel: "Carriers Integrated",
    },
    {
      icon: Lock,
      title: "Enterprise Tenant Isolation",
      tag: "DATA SECURITY",
      desc: "Scoped per-tenant database records and vector spaces. Private business documents and call transcripts are strictly isolated by tenant ID.",
      stat: "Scoped",
